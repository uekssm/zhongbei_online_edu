...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <body>
  ...
  <div id="content" class="hide">
      <form id="J_Form" class="form-horizontal" action="<{:U('User/doadd')}>">
...
<script type="text/javascript">
  ...
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          {title:'员工编号',dataIndex:'job_number',width:90},
          {title:'姓名',dataIndex:'name',width:100},
          {title:'入职时间',dataIndex:'hiredate',width:100},
          {title:'状态',dataIndex:'status',width:100,renderer:BUI.Grid.Format.enumRenderer({'0':'离职','1':'在职'})},
          {title:'所属部门',dataIndex:'posname',width:100},
          {title:'性别',dataIndex:'sex',width:50,renderer:BUI.Grid.Format.enumRenderer({'0':'女','1':'男'})},
          {title:'电话',dataIndex:'tel',width:100},
          {title:'头像',dataIndex:'photo',width:100,renderer:function(value,obj){
