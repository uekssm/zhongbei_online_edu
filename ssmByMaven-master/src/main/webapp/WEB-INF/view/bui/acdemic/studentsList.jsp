...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          {title:'学号',dataIndex:'student_number',width:100},
          {title:'姓名',dataIndex:'name',width:80},
          {title:'项目组',dataIndex:'pro_team_id',width:100},
          {title:'状态',dataIndex:'status',width:60,renderer:BUI.Grid.Format.enumRenderer({'0':'禁用','1':'计划学员','2':'正式学员'})},
          {title:'性别',dataIndex:'gender',width:50,renderer:BUI.Grid.Format.enumRenderer({'1':'男','0':'女'})},
      ...
      store = Search.createStore('${pageContext.request.contextPath }/students/getAllStudents',{
        proxy : {
