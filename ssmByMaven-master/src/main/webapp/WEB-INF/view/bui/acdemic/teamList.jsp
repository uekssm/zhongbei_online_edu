...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          ...
          {title:'项目组',dataIndex:'name',width:100},
          {title:'教室',dataIndex:'classname',width:100},
          {title:'组长',dataIndex:'headstu',width:100},
      ...
      store = Search.createStore('${pageContext.request.contextPath }/team/getAllTeam',{
        proxy : {
