      ...
      <form id="J_Form" class="form-horizontal" action="<{:U('university/add')}>">
        ...
        <div class="row">
          <div class="control-group span8">
            ...
            <div class="controls">
              <input name="about" type="text" class="input-normal control-text">
            </div>
          </div>
        </div>
        <div class="row">
...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          {title:'课程编号',dataIndex:'num',width:80},
          {title:'课程名称',dataIndex:'name',width:200},
          {title:'课程介绍',dataIndex:'summary',width:500},
          {title:'课程封面',dataIndex:'cover_image',width:100,renderer : function(value,obj){
      ...
      store = Search.createStore('${pageContext.request.contextPath }/course/getAllCourse',{
        proxy : {
