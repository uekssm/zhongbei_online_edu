...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          {title:'工号',dataIndex:'job_number',width:100},
          {title:'姓名',dataIndex:'name',width:80},
          {title:'入职时间',dataIndex:'hiredate',width:150},
          {title:'状态',dataIndex:'status',width:50,renderer:BUI.Grid.Format.enumRenderer({'1':'在职','0':'离职'})},
          {title:'性别',dataIndex:'sex',width:50,renderer:BUI.Grid.Format.enumRenderer({'1':'男','0':'女'})},
      ...
      store = Search.createStore('${pageContext.request.contextPath }/teacher/getAllTeacher',{
        proxy : {
