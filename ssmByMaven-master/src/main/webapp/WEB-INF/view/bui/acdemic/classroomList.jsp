...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          ...
          {title:'教室',dataIndex:'name',width:100},
          {title:'容量/人',dataIndex:'num',width:100},
          {title:'电脑数量/(台|个)',dataIndex:'computer_num',width:100},
          {title:'已容纳/人',dataIndex:'station',width:100},
      ...
      store = Search.createStore('${pageContext.request.contextPath }/classroom/getAllClassroom',{
        proxy : {
