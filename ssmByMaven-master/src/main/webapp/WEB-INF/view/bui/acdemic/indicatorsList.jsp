...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          ...
          {title:'指标名',dataIndex:'name',width:500},
          {title:'权重',dataIndex:'weight',width:50},
      ...
      store = Search.createStore('${pageContext.request.contextPath }/indicators/getAllIndicators',{
        proxy : {
