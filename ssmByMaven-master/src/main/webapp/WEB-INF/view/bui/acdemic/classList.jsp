...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          {title:'序号',dataIndex:'num',width:60},
          {title:'班级名称',dataIndex:'name',width:100},
          {title:'教室',dataIndex:'room_id',width:100},
          {title:'专业',dataIndex:'major_id',width:200},
      ...
      store = Search.createStore('${pageContext.request.contextPath }/class/getAllClass',{
        proxy : {
