 ...
 <body>
      ...
      <form id="searchForm" class="form-horizontal span24">
        <div class="row">
          ...
          <div class="control-group span8">
            ...
            <div class="controls">
              <select name="subject_id" class="control-text">
  ...
  <div id="content" class="hide">
      <form id="J_Form" class="form-horizontal" action="<{:U('university/add')}>">
        ...
        <div class="row">
          <div class="control-group span8">
            <label class="control-label"><s>*</s>方向编号</label>
            <div class="controls">
        ...
        <div class="row">
          <div class="control-group span8">
            <label class="control-label">方向介绍</label>
            <div class="controls">
        ...
        <div class="row">
          <div class="control-group span8">
            <label class="control-label">方向封面</label>
            <div class="controls">
              <input name="cover_image" type="file" class="input-normal control-text">
            </div>
          </div>
        </div>
       <div class="row">
	        	<div class="control-group span8">
		        	<label class="control-label">所属专业</label>
		            <div class="controls">
		              	<select  name="subject_id" class="input-normal">
...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          {title:'方向编号',dataIndex:'num',width:80},
          {title:'方向名称',dataIndex:'name',width:200},
          {title:'方向介绍',dataIndex:'summary',width:500},
          {title:'方向封面',dataIndex:'cover_image',width:100,renderer : function(value,obj){
      ...
      store = Search.createStore('${pageContext.request.contextPath }/direction/getAllDirection',{
        proxy : {
