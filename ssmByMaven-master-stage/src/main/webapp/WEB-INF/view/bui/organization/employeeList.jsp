...
<script type="text/javascript">
  ...
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          {title:'员工编号',dataIndex:'job_number',width:80},
          {title:'姓名',dataIndex:'name',width:100},
          {title:'入职时间',dataIndex:'hiredate',width:300},
          {title:'状态',dataIndex:'status',width:100},
          {title:'所属部门',dataIndex:'position_id',width:80},
          {title:'性别',dataIndex:'sex',width:300},
          {title:'电话',dataIndex:'tel',width:100},
          {title:'头像',dataIndex:'photo',width:100},
          /* 
