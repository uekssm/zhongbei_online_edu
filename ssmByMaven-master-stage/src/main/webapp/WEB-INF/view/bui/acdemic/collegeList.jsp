...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          {title:'学院编号',dataIndex:'num',width:80},
          {title:'学院名称',dataIndex:'name',width:200},
          {title:'学院介绍',dataIndex:'summary',width:500},
      ...
      store = Search.createStore('${pageContext.request.contextPath }/college/getAllCollege',{
        proxy : {
