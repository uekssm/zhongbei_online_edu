...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          {title:'学科编号',dataIndex:'num',width:80},
          {title:'学科名称',dataIndex:'name',width:200},
          {title:'学科介绍',dataIndex:'summary',width:500},
          {title:'学科级别',dataIndex:'level',width:100},
      ...
      store = Search.createStore('${pageContext.request.contextPath }/subject/getAllSubject',{
        proxy : {
