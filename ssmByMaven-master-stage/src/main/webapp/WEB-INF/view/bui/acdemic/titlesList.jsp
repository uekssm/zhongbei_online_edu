...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          {title:'编号',dataIndex:'num',width:120},
           {title:'类型',dataIndex:'category',width:50},
           {title:'题目',dataIndex:'title',width:700},
           ...
           //{title:'答案',dataIndex:'answer',width:150},
           // {title:'解析',dataIndex:'analysis',width:150},
           // {title:'出题老师',dataIndex:'teacher',width:100},
           // {title:'添加时间',dataIndex:'add_time',width:140},
           // {title:'画图截图',dataIndex:'url',width:140},
            {title:'分值',dataIndex:'score',width:40},
           {title:'时间',dataIndex:'complete_time',width:60},
           /* {title:'出题人',dataIndex:'teacher',width:60},
           {title:'导入者',dataIndex:'importer',width:60}, */
